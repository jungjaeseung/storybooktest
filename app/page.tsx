      ...
      <div className="flex hidden sm:flex">
        ...
        <ChatContainer
          chatData={[
            ...
            [{ send: "janedoe", message: "Hey, How's it going?" }],
            [
              {
                send: "writerkim",
                message:
            ...
            [{ send: "jungjaeseung", message: "안녕하세요." }],
          ]}
          chatInfo={[
            { isReaden: true, roomName: "John Doe" },
            { isReaden: false, roomName: "Jane Doe" },
            { isReaden: false, roomName: "Writer Kim" },
            { isReaden: false, roomName: "Jaeseung Jung" },
          ]}
        />
      </div>
